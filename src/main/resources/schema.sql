    ...
    CREATE TABLE aluno(
      ...
      instrutor_id int,
      CONSTRAINT fk_instrutor_id FOREIGN KEY (instrutor_id) REFERENCES instrutor(instrutor_id)
	...
	INSERT INTO exercicio VALUES (null,'remada baixa','3 séries de 12 repetições',2);
	INSERT INTO exercicio VALUES (null,'leg 180','3 séries de 12 repetições',3);